...
![client_docs-google_rating-example](/img/google_star/client_docs-google_rating-example.png)
...
:::note
If you want the rating for one product, your filters <b>SHALL</b> be as restrictive as possible. Inversely, if you want an aggregate note for an index of products (such as all your blue shoes), filter should logically contains less filters than the previous example.
...
- choose `code block`![google_star_test](/img/google_star/test.png)<br />
- paste all your html product(s) page and click on `test`<br />
- you should see something like that : ![google_star_test_1](/img/google_star/test_1.png)<br />
...
Then go to the `crawl` folder, in `Sitemaps` section ![webtool1](/img/google_star/webtool_1.png)<br />
Finaly, click on `add/test` sitemaps and click on submit. ![webtool2](/img/google_star/webtool_2.png)<br />
